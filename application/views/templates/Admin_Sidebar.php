    ...
    <div class="col-md-3 left_col">
      <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
          <a href="<?= base_url('admin'); ?>" class="site_title"><i class="fa fa-eye"></i> <span>Pendeteksi Mata Rabun</span></a>
        </div>
        ...
        <div class="profile clearfix">
          <div class="profile_pic">
            <img src="<?= base_url('assets_admin/images/') . $user['image']; ?>" class="img-circle profile_img">
          </div>
