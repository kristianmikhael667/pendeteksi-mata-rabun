                        ...
                        <div class="rd-navbar-main">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <div class="rd-navbar-brand">
                                    <!--Brand--><a class="brand" href="<?= base_url('/member') ?>"><img class="brand-logo-dark" src="assets/images/logo.jpeg" alt="" width="147" height="22" /><img class="brand-logo-light" src="assets/images/logo.jpeg" alt="" width="147" height="22" /></a>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row row-30">
                        <div class="col-xl-12 order-1 wow fadeInLeft">
                            <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="assets/images/logo.jpeg" alt="" width="147" height="22" /><img class="brand-logo-light" src="assets/images/logo.jpeg" alt="" width="147" height="22" /></a>
