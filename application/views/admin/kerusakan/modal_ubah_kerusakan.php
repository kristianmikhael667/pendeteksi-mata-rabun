<!-- Modal Edit -->
<?php foreach ($tbl_penyakit as $rusak) : ?>
  <div class="modal fade ubahKerusakan<?= $rusak['id_penyakit']; ?>" tabindex="-1" role="dialog" aria-labelledby="forModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <input type="hidden" name="id" value="<?= $rusak['id_penyakit']; ?>">
        <div class="modal-body">
          <div class="form-group">
            <label for="kode">Kode Kerusakan</label>
            <input type="text" class="form-control" id="kode" name="kode" value="<?= $rusak['kode_penyakit']; ?>" readonly>
          </div>
          <div class="form-group">
            <label for="nama">Nama Kerusakan</label>
            <input type="text" class="form-control" id="nama" name="nama" value="<?= $rusak['nama_penyakit']; ?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <img style="margin-bottom: 10px; width: 100px;" src=" <?= base_url('assets_admin/images/kerusakan/') . $rusak['gambar']; ?>">
